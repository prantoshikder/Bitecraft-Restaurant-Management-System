...
export default function ContactPage() {
  return (
    <>
      <PageBanner title="Contact Us" subtitle="Get In Touch" crumb="Contact" image={IMG.interiors[3]} />
      ...
      <section className="bg-cream py-16 lg:py-20">
        ...
        <div className="container-x mt-14 grid gap-8 lg:grid-cols-2">
          <Reveal direction="right">
            ...
            <h2 className="section-title mt-3 text-ink">We&apos;d Love To Hear From You</h2>
            <p className="mt-3 max-w-md text-sm text-muted">
              Have a question, a special request or a partnership idea? Fill in the form and our team
          ...
          <Reveal direction="left" delay={0.1}>
            <div className="h-full min-h-[420px] overflow-hidden rounded-3xl border border-ink/8">
              <iframe
