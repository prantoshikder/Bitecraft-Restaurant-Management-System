...
import { WHY_CHOOSE_US_FEATURES as FEATURES } from "@/temp/home";

export default function WhyChooseUs() {
  return (
    <section className="overflow-hidden bg-ink">
      <div className="container-x grid items-stretch gap-0 lg:grid-cols-2">
        <Reveal direction="right" className="relative min-h-85 lg:min-h-130">
          <div className="relative h-full w-full overflow-hidden lg:rounded-r-3xl">
            ...
            />
            <div className="absolute inset-0 bg-linear-to-r from-transparent to-ink" />
          </div>
        </Reveal>
        ...
        <div className="flex flex-col justify-center py-16 lg:pl-14 lg:pr-4">
          <Reveal direction="left">
            ...
            <h2 className="section-title mt-3 max-w-sm text-white">
