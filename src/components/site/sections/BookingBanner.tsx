...
export default function BookingBanner() {
  return (
    <section id="reservation" className="relative overflow-hidden bg-ink py-20 lg:py-24">
      ...
      <div className="container-x relative grid gap-6 lg:grid-cols-[1.5fr_1fr]">
        <Reveal direction="right" className="rounded-3xl border border-white/8 bg-white/[0.03] p-8 sm:p-10">
          <span className="font-script text-3xl text-brand-light">Book A Table</span>
          <h2 className="mt-1 text-3xl font-extrabold text-white sm:text-4xl">
            Reserve Your Table
            <br /> For A Great Experience
          </h2>
          <p className="mt-3 max-w-md text-sm text-white/50">
            Planning a special evening? Reserve your table in seconds and let us take care of the
            rest.
          </p>
          <div className="mt-8">
            <ReservationForm />
        ...
        <Reveal direction="left" delay={0.1} className="flex flex-col justify-between rounded-3xl bg-brand p-8 sm:p-10">
          <div>
          ...
          <div className="mt-10">
            <p className="mb-3 text-[11px] uppercase tracking-wider text-white/60">Follow Us</p>
